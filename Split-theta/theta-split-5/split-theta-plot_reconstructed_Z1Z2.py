...
if __name__ == "__main__":
    if len(sys.argv) != 6:
        print("Usage: python3 split-theta-plot_reconstructed_Z1Z2.py <theta_tx> <theta_ty> <theta_xy> <theta_xz> <theta_yz>")
        sys.exit(1)
    ...
    input_file = f"files-reconstructed/Reconstructed_Z1Z2_LHEF_{theta_tag}.root"
    tree_name = "LHEF"

    output_dir = f"plots/{theta_tag}/split_theta_z1z2"
